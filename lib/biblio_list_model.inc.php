...
abstract class biblio_list_model {
    ...
    protected function makeOutput()
    {
        ...
        if (!$this->resultset) {
            ...
            empty($_biblio_d['icon_image']) ? $image = '<div class="gmd-label"  rel="tooltip" title="'.$_biblio_d['gmd_name'].'" data-placement="right"><span class="label label-info " >'.$_biblio_d['gmd_name'].'</span></div>' : $image = '<div class="gmd-label" rel="tooltip" title="'.$_biblio_d['gmd_name'].'" data-placement="right"><span class="label label-info" ><img src="images/icons/' . $_biblio_d['icon_image'] . '" /></span></div>';
