...
<div class="menuBoxInner masterFileIcon">
	...
	<div class="sub_section">
      ...
      <a href="<?php echo MWB; ?>master_file/index.php" class="headerText2"><?php echo __('GMD List'); ?></a>
      <a href="<?php echo MWB; ?>master_file/index.php?action=detail" class="headerText2"><?php echo __('Add New GMD'); ?></a>
	  </div>
